    ...
    <section class="main-slider hp3">
      <div class="container">
                ...
                <!-- LAYER NR. 1 -->
                     ...
                     "UniChain Üniversiteler Arası Blockchain Topluluğu"
                ...
                <!-- LAYER NR. 2 -->
                    ...
                    Blockchain teknolojisini güncel olarak takip eden,<br>
										öğrenen, öğreten ve geliştiren, <br>üniversite öğrencileri
										 ve toplulukları arası <br>bir zincire halka olmak  ister misiniz?<br>
